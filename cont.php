...
<body>
<header>
  <div class="container"> <a href="http://www.monarc.dx.am" class="logo">
    <hgroup>
      <h1>CV</h1>
...
<section class="banner_rotator">
  <ul class="bxslider">
    <li><img src="images/slide_1.JPG" title="HTML & CSS" data-description="<b>formation en 2015.</b>" /></li>
    <li><img src="images/slide_2.JPG" title="Javascript" data-description="<b>Formation 2015 & autodidacte (REACT & JQUERY).</b>"  /></li>
    <li><img src="images/slide_3.JPG" title="Developpement logiciel" data-description="<b>JAVA (Swing)  &  PYTHON (Tkinter) ==> Autodidacte.</b>" /></li>
  </ul>
</section>
<section class="page">
  <div class="container">
    ...
    <form class="webform" enctype="multipart/form-data" action="/" method="post"
      id="webform-client-form-1" accept-charset="UTF-8"><div><div class="form-item-name  id="webform-component">
...
<div class="textarea" id="webform-message">
 ...
 <div class="form-textarea-wrapper"><textarea id="edit-submitted-message" name="submitted[message]" cols="60" rows="5" class="form-textarea required">Message</textarea></div>
</div>
<input type="hidden" name="details[sid]" />
<input type="hidden" name="details[page_num]" value="1" />
<input type="hidden" name="details[page_count]" value="1" />
<input type="hidden" name="details[finished]" value="0" />
<input type="hidden" name="form_build_id" value="form-Z14OzV_0AY4oP-sGX9ogpK1uf-DfcaogICf94hlYSoI" />
